...
import controller.CtrlUpdateTamu;
 ...
 */
public class UpdateTamu extends javax.swing.JFrame {
    ...
    CtrlUpdateTamu tamu;
    Input input;
    public UpdateTamu(Input input) {
        this.input = input;
        this.tamu = new CtrlUpdateTamu(this);
        initComponents();
        this.tamu.add(this.input);
    }
