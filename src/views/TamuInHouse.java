...
import backend.DB;
import controller.CtrlTamuInHouse;
 ...
 */
public class TamuInHouse extends javax.swing.JFrame {

    /**
     * Creates new form CheckIn
     */
    CtrlTamuInHouse tamu;
    public TamuInHouse() {
        this.tamu = new CtrlTamuInHouse(this);
        initComponents();
        this.tamu.add();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Tamu In House");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, -1, -1));

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(204, 204, 204));
        jLabel2.setText("Lihat tamu yang sedang menginap");
        ...
        tableLihatTamu.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "#Kamar", "Nama Tamu", "Tanggal Check In", "Tanggal Check Out", "Sisa Deposit"
            }
        ));
